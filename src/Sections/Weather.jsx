...
const RestPage = () => {
  return (
    <div className="h-screen bg-white px-44 py-12 mt-16">
      <div className="mb-16">
        <h1 className="text-center text-4xl font-bold mb-2">Restuarants Donor Program</h1>
        <p className="text-center font-semibold text-gray-500">
        A Restaurant Donor Program involves restaurants donating surplus food to combat food waste and alleviate hunger. Through collaboration with non-profit organizations, edible excess food is distributed to those in need, showcasing a commitment to social responsibility and sustainability. The initiative aims to make a positive impact on communities by providing access to fresh, high-quality meals.{" "}
        </p>
      </div>
